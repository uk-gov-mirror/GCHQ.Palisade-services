...
import uk.gov.gchq.palisade.service.resource.common.util.UriBuilder;
...
class ResourceBuilderTest {
    ...
    void testInvalidSchemaThrowsException() throws URISyntaxException {
        ...
        assertThat(exception)
                ...
                .isEqualTo("No enum constant uk.gov.gchq.palisade.service.resource.common.util.ResourceBuilder.Scheme.BADSCHEMA");
    }
