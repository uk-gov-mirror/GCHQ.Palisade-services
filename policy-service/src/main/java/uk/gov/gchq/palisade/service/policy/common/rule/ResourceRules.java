...
public class ResourceRules implements Serializable {
    ...
    private LinkedHashMap<String, Rule<Resource>> rulesMap;
     ...
     */
    @Generated
    public ResourceRules rules(final Map<String, Rule<Resource>> rules) {
        this.setRules(rules);
        return this;
    }
    ...
    @Generated
    public ResourceRules addRules(final Map<String, Rule<Resource>> rules) {
     ...
     */
    @Generated
    public ResourceRules message(final String message) {
     ...
     */
    @Generated
    public ResourceRules addRule(final String id, final Rule<Resource> rule) {
    ...
    @Generated
    public Map<String, Rule<Resource>> getRules() {
        return rulesMap;
    }

    @Generated
    public void setRules(final Map<String, Rule<Resource>> rulesMap) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ResourceRules)) {
            return false;
        }
        ResourceRules other = (ResourceRules) o;
    ...
    public String toString() {
        return new StringJoiner(", ", ResourceRules.class.getSimpleName() + "[", "]")
                .add("message='" + message + "'")
